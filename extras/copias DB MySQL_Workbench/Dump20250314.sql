...
CREATE TABLE `usuarios` (
  ...
  `token` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `usuarios` VALUES (6,'Admin','Admin','admin@admin.com','$2y$10$HhOgL3tlAyTXKV.dSQt0d.mhHd8oyJlfRrUdrG6ctxQzQkAGQP7em','123456789',1,1,''),(7,'Cliente','Sin confirmar','cliente@sinconfirmar.com','$2y$10$e/oB.bLO14sVVwZPYpDFeOjwXeeE/7yQUhpCLsg5JGG8XfP6gllf6','321654987',0,0,'67d2c9e57d688'),(9,'Cliente','Confirmado','cliente@confirmado.com','$2y$10$AYZFcIGMJGgxIaNWb0YE6OgrSeDkJSnf8/Favv1YytaW/Vu4gPMY6','456654878',0,1,'');
...
-- Dump completed on 2025-03-14 17:48:29
